...
2. Download the complete [v0.13.22 Windows ZIP](https://github.com/pixelgraple/KREA2-Vision-Suite/raw/main/releases/Krea2VisionSuite-v0.13.22-win64.zip). Do not download only the `.plugin.js` file.
