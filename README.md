...
Download [Krea2VisionSuite-v0.13.22-win64.zip](releases/Krea2VisionSuite-v0.13.22-win64.zip). Right-click the ZIP, choose **Properties**, enable **Unblock**, apply the change, extract it, and run:
