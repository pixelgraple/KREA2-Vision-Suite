...
- Prompt History keeps at most 250 local image previews. Each is capped at 640 px and 2 MiB, keyed by the source SHA-256, and saved under the configured local folder's `.krea2-history-thumbnails` subfolder.
